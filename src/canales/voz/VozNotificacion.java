...
public class VozNotificacion implements Notificacion {
    ...
    private String convertirTextoAVoz(String texto) {
        return "[AUDIO:" + texto + "]";
    }

    private void registrarEstadistica(String numero, String mensaje, int intentos) {
        System.out.println("Registro de llamada: " + numero + " | Intentos: " + intentos + " | Longitud: " + mensaje.length());
    }
